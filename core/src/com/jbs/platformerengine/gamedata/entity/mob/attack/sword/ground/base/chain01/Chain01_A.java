...
public class Chain01_A extends AttackData {
    public Chain01_A() {
        ...
        attackHitBoxData.yLocationPercentModList = new float[] {.4f};
        ...
        // Attack Chain(s) //
        attackChainMap.put(10, new com.jbs.platformerengine.gamedata.entity.mob.attack.sword.ground.base.chain01.Chain01_B());
    }
}
